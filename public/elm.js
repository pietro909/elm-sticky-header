		...
		A2(
			...
			function (b) {
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_pietro909$elm_sticky_header$StickyHeader$makeLink(b)
						]));
			},
			model.brand));
...
var _pietro909$elm_sticky_header$StickyHeader$subscriptions = function (model) {
	return _elm_lang$core$Native_List.fromArray(
		[
			_pietro909$elm_sticky_header$Ports$scroll(_pietro909$elm_sticky_header$StickyHeader$Header),
			A2(
...
var _pietro909$elm_sticky_header$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		A2(
			...
			_pietro909$elm_sticky_header$StickyHeader$subscriptions(model.headerModel)));
};
