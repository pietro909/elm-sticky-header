			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							active: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _pietro909$elm_sticky_header$StickyHeader$initialModel = F2(
...
var _pietro909$elm_sticky_header$StickyHeader$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {style: a, current: b, nextGoal: c, brand: d, links: e, speedUp: f, speedDown: g, active: h};
	});
...
var _pietro909$elm_sticky_header$Ports$scroll = _elm_lang$core$Native_Platform.incomingPort(
	'scroll',
	A3(
...
var _pietro909$elm_sticky_header$Main$initialModel = function () {
	...
	return {
		headerModel: A2(
			...
			_pietro909$elm_sticky_header$Main$headerLinks)
	};
}();
var _pietro909$elm_sticky_header$Main$init = {ctor: '_Tuple2', _0: _pietro909$elm_sticky_header$Main$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _pietro909$elm_sticky_header$Main$Model = function (a) {
	return {headerModel: a};
};
var _pietro909$elm_sticky_header$Main$StickyHeaderMsg = function (a) {
	return {ctor: 'StickyHeaderMsg', _0: a};
};
var _pietro909$elm_sticky_header$Main$update = F2(
	function (msg, model) {
		...
		return {
			...
			_1: A2(_elm_lang$core$Platform_Cmd$map, _pietro909$elm_sticky_header$Main$StickyHeaderMsg, headerCmd)
		};
	});
var _pietro909$elm_sticky_header$Main$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_pietro909$elm_sticky_header$Main$StickyHeaderMsg,
				_pietro909$elm_sticky_header$StickyHeader$view(model.headerModel))
			]));
};
var _pietro909$elm_sticky_header$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		A2(
			_elm_lang$core$List$map,
			_elm_lang$core$Platform_Sub$map(_pietro909$elm_sticky_header$Main$StickyHeaderMsg),
			A2(_pietro909$elm_sticky_header$StickyHeader$subscriptions, _pietro909$elm_sticky_header$Ports$scroll, model.headerModel)));
};
var _pietro909$elm_sticky_header$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _pietro909$elm_sticky_header$Main$init, subscriptions: _pietro909$elm_sticky_header$Main$subscriptions, update: _pietro909$elm_sticky_header$Main$update, view: _pietro909$elm_sticky_header$Main$view})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _pietro909$elm_sticky_header$Main$main === 'undefined' ? null : _pietro909$elm_sticky_header$Main$main);
